...
mod image_helper {
    ...
    pub fn show() {
        ...
        table.set_titles(Row::new(vec![
            Cell::new("Index").with_style(Attr::Bold).with_style(Attr::ForegroundColor(color::GREEN)),
            ...
            Cell::new("Tag").with_style(Attr::Bold).with_style(Attr::ForegroundColor(color::GREEN)),
            Cell::new("Size").with_style(Attr::Bold).with_style(Attr::ForegroundColor(color::GREEN)),
            Cell::new("Created").with_style(Attr::Bold).with_style(Attr::ForegroundColor(color::GREEN))
        ]));
